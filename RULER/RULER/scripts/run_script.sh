...
export L=4096 # LSH hyper-parameter for MagicPIG and number of selected pages for Quest
bash run.sh llama3-8b-chat-128k synthetic $K $L $sink $local $model $expid

export L=2048 # LSH hyper-parameter for MagicPIG and number of selected pages for Quest
bash run.sh llama3-8b-chat-128k synthetic $K $L $sink $local $model $expid
